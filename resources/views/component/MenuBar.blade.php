                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-center justify-content-center justify-content-md-start">
                        <ul class="contact_detail text-center text-lg-start">
                            <li><i class="ti-mobile"></i><span>+88 01881-324067</span></li>
                            <li><i class="ti-email"></i><span>engrsaju289@gmail.com</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg">
                <a class="navbar-brand" href="{{url("/")}}">
                    <img class="logo_dark" src="{{ asset('assets/images/logo1.png')}}" alt="logo" style="width: 150, height: 50"/>
                </a>
