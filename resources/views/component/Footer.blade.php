<footer class="footer_dark">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="widget">
                        <div class="footer_logo">
                            <a href="#"><img src="{{ asset('assets/images/logo2.png')}}" alt="logo" style="width: 150px"/></a>
                    ...
                    <div class="widget">
                        ...
                        <ul class="contact_info contact_info_light">
                            <li>
                                ...
                                <p>1312 Farmgate, Dhaka, Bangladesh</p>
                            </li>
                            <li>
                                <i class="ti-email"></i>
                                <a href="mailto:info@sitename.com">engrsaju289@gmail.com</a>
                            </li>
                            <li>
                                <i class="ti-mobile"></i>
                                <p>+88 01881-324067</p>
    ...
    <div class="bottom_footer border-top-tran">
        <div class="container">
            <div class="row">
                <div class="col-md-6 d-flex align-items-center justify-conter">
                    <p class="mb-md-0 text-center text-md-start">© 2024 All Rights Reserved by Ti Saju    .</p>
                    <img src="{{ asset('assets/images/ti.jpg') }}" alt="logo" style="width: 50px; height:50px; border-radius: 50%" />
                </div>
                <div class="col-md-6">
