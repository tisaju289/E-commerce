            ...
            <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                <div class="product-image">
                    <div class="product_img_box">
                        <img id="product_img1" class="w-100" src="assets/images/product_small_img3.jpg" />
                    </div>
                    <div class="row p-2">
...
<script>
    ...
    async function productDetails() {
        ...
        document.getElementById('product_img1').src='{{ asset('storage') }}/'+Details[0]['img1'];
        document.getElementById('img1').src='{{ asset('storage') }}/'+Details[0]['img1'];
        document.getElementById('img2').src='{{ asset('storage') }}/'+Details[0]['img2'];
        document.getElementById('img3').src='{{ asset('storage') }}/'+Details[0]['img3'];
        document.getElementById('img4').src='{{ asset('storage') }}/'+Details[0]['img4'];
        ...
        $('#img1').on('click', function() {
            $('#product_img1').attr('src','{{ asset('storage') }}/'+Details[0]['img1']);
        });
        $('#img2').on('click', function() {
            $('#product_img1').attr('src','{{ asset('storage') }}/'+Details[0]['img2']);
        });
        $('#img3').on('click', function() {
            $('#product_img1').attr('src','{{ asset('storage') }}/'+Details[0]['img3']);
        });
        $('#img4').on('click', function() {
            $('#product_img1').attr('src','{{ asset('storage') }}/'+Details[0]['img4']);
        });
    }
