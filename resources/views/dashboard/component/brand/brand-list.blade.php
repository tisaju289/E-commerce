...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="mb-2">
          <a href="{{ url('brandCreatePage') }}" class="btn btn-success w-15">Brand Create</a>
        </div>
        ...
        <table class="table table-striped border border-primary">
          <thead class="thead-white text-center bg-gray border border-primary">
            <tr class="border border-primary">
              ...
              <th class="border border-white" scope="col">Brand Name</th>
              <th class="border border-white" scope="col">Brand Image</th>
          ...
          <tbody class="text-center border border-primary">
            ...
            <tr class="border border-primary">
                ...
                <td class="border border-primary">{{ $brand->brandName }}</td>
                <td class="border border-primary">
                  <img src="{{ asset('storage/' . $brand->brandImg) }}" alt="Brand Image" width="50">
                </td>
                <td class="border border-primary">
                  <a href="{{ route('brand.update.page', $brand->id) }}" class="btn btn-primary">Edit</a>
